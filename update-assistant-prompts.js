...
const prompts = {
  cline: `# Prompt for Cursor Cline: Architecture Planning for Ritual Engine
...
Label the PR: \`[#architecture] Ritual Engine Component Design\``,
  ...
  roo: `# Prompt for Cursor Roo: CLI Tool for Protocol Validation
...
Label the PR: \`[#tools] Protocol Validation CLI\``,
  ...
  vibecheck: `# Prompt for Cursor VibeCheck: Protocol Consistency Validator
...
Label the PR: \`[#quality] Protocol Consistency Validator\``,
  ...
  cursorscan: `# Prompt for Cursor CursorScan: Protocol Lifecycle Tracker
...
Label the PR: \`[#metadata] Protocol Lifecycle Tracking System\``,
  ...
  promptrouter: `# Prompt for Cursor PromptRouter: Intent-Based Routing System
...
Label the PR: \`[#orchestration] Intent-Based Prompt Routing System\``,
  ...
  strategicai: `# Prompt for Cursor StrategicAI: Protocol-Aligned Prompt Blueprint Generator
...
Label the PR: \`[#prompts] Protocol-Aligned Blueprint Generator\``,
  ...
  augment: `# Prompt for Cursor Augment: Enhance Prompt Extractor
...
// Output directory
const outputDir = 'assistant-prompts';
...
for (const [assistant, prompt] of Object.entries(prompts)) {
  ...
  console.log(`Saved prompt for ${assistant} to ${filePath}`);
}
...
console.log(`Saved combined prompts to ${combinedPath}`);

console.log('Assistant prompt update complete');
